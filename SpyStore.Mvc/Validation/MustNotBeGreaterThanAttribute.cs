...
namespace SpyStore.Mvc.Validation
{
    ...
    IClientModelValidator
    {
        ...
        public MustNotBeGreaterThanAttribute(
            string otherPropertyName, string prefix = "")
        ...
        {
            var displayAttribute = otherPropertyInfo.GetCustomAttributes<DisplayAttribute>()
                .FirstOrDefault();
            ...
            object value, ValidationContext validationContext)
        {
            ...
            var otherValue = (int)otherPropertyInfo.GetValue(
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            var propertyInfo = context
                .ModelMetadata.ContainerType.GetProperty(_otherPropertyName);
            ...
            context.Attributes
                .Add("data-val-notgreaterthan-otherpropertyname", _otherPropertyName);
            context.Attributes
                .Add("data-val-notgreaterthan-prefix", _prefix);
        }
    }
}
